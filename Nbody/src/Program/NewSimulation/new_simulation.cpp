#include "new_simulation.h"
#include <cmath>
/**/
/*const std::vector<Particle> &NewSimulation::GetParticles() const {*/
/*  return particles_;*/
/*}*/
/**/
/*Vec GetForce(const Vec &v1, const Vec &v2, nb_t mass1, nb_t mass2) {*/
/*  Vec dr = {v1.x - v2.x, v1.y - v2.y, v1.z - v2.z};*/
/**/
/*  nb_t r2 = dr.x * dr.x + dr.y * dr.y + dr.z * dr.z;*/
/**/
/*  if (r2 < MinDistance) {*/
/*    r2 = MinDistance;*/
/*  }*/
/**/
/*  nb_t g = ((-GravityConstSI * mass1 * mass2) / (r2 * std::sqrt(r2)));*/
/**/
/*  return (Vec){dr.x * g, dr.y * g, dr.z * g};*/
/*}*/
/**/
/*void NewSimulation::OnUpdate(float ts) {*/
/**/
/*  size_t count;*/
/*  const nb_t *rx;*/
/*  const nb_t *ry = rx + count;*/
/*  const nb_t *rz = rx + 2 * count;*/
/*  const nb_t *vx = rx + 3 * count;*/
/*  const nb_t *vy = rx + 4 * count;*/
/*  const nb_t *vz = rx + 5 * count;*/
/**/
/*  nb_t *frx;*/
/*  nb_t *fry = frx + count;*/
/*  nb_t *frz = frx + 2 * count;*/
/*  nb_t *fvx = frx + 3 * count;*/
/*  nb_t *fvy = frx + 4 * count;*/
/*  nb_t *fvz = frx + 5 * count;*/
/**/
/*  const nb_t *mass;*/
/**/
/*  for (int i = 0; i < particles_.size(); ++i) {*/
/*    Vec v1 = particles_[i].position;*/
/*    Vec total_force = {0, 0, 0};*/
/**/
/*    for (int j = 0; j < particles_.size(); ++j) {*/
/*      if (i == j)*/
/*        continue;*/
/*      Vec v2 = particles_[j].position;*/
/*      Vec force = GetForce(v1, v2, particles_[i].mass, particles_[j].mass);*/
/*    }*/
/**/
/*  }*/
/**/
...
/*}*/
/**/
/*nbody_engine::memory *nbody_engine_simple::get_y() { return m_y; }*/
/**/
/*void nbody_engine_simple::advise_time(const nbcoord_t &dt) {*/
/*  m_data->advise_time(dt);*/
/*}*/
/**/
/*nbcoord_t nbody_engine_simple::get_time() const { return m_data->get_time();
 * }*/
/**/
/*void nbody_engine_simple::set_time(nbcoord_t t) { m_data->set_time(t); }*/
/**/
/*size_t nbody_engine_simple::get_step() const { return m_data->get_step(); }*/
/**/
/*void nbody_engine_simple::set_step(size_t s) { m_data->set_step(s); }*/
/**/
/*void nbody_engine_simple::fcompute(const nbcoord_t &t, const memory *_y,*/
/*                                   memory *_f) {*/
/*  Q_UNUSED(t);*/
...
/**/
/*  const nbcoord_t *mass = reinterpret_cast<const nbcoord_t
 * *>(m_mass->data());*/
/**/
...
/*      const nbvertex_t force(m_data->force(v1, v2, mass[body1],
 * mass[body2]));*/
/*      total_force += force;*/
/*    }*/
/*    frx[body1] = vx[body1];*/
...
/*}*/
/**/
/*void nbody_engine_simple::free_buffer(memory *m) { delete m; }*/
/**/
...
/*}*/
/**/
/*void nbody_engine_simple::copy_buffer(nbody_engine::memory *__a,*/
/*                                      const nbody_engine::memory *__b) {*/
...
/*}*/
/**/
/*void nbody_engine_simple::fill_buffer(nbody_engine::memory *__a,*/
/*                                      const nbcoord_t &value) {*/
/*  smemory *_a = dynamic_cast<smemory *>(__a);*/
/**/
/*  if (_a == NULL) {*/
/*    qDebug() << "a is not smemory";*/
...
/*}*/
/**/
/*void nbody_engine_simple::fmadd_inplace(memory *__a, const memory *__b,*/
/*                                        const nbcoord_t &c) {*/
/*  smemory *_a = dynamic_cast<smemory *>(__a);*/
/*  const smemory *_b = dynamic_cast<const smemory *>(__b);*/
/**/
...
/*}*/
/**/
/*void nbody_engine_simple::fmadd(memory *__a, const memory *__b,*/
/*                                const memory *__c, const nbcoord_t &d) {*/
/*  smemory *_a = dynamic_cast<smemory *>(__a);*/
/*  const smemory *_b = dynamic_cast<const smemory *>(__b);*/
...
/*}*/
/**/
/*void nbody_engine_simple::fmaddn_corr(memory *__a, memory *__corr,*/
/*                                      const memory_array &__b,*/
...
/*}*/
/**/
/*void nbody_engine_simple::fmaxabs(const nbody_engine::memory *__a,*/
/*                                  nbcoord_t &result) {*/
...
/*}*/
/**/
/*nbody_engine_simple::smemory::~smemory() { ::free(m_data); }*/
/**/
/*void *nbody_engine_simple::smemory::data() { return m_data; }*/
/**/
/*const void *nbody_engine_simple::smemory::data() const { return m_data; }*/
/**/
/*size_t nbody_engine_simple::smemory::size() const { return m_size; }*/
